...
namespace IapDesktop.Application.Avalonia.Services.Ssh.Metadata
{
    ...
    public abstract class MetadataAuthorizedPublicKey
        : IEquatable<MetadataAuthorizedPublicKey> //, IAuthorizedPublicKey -- simplifying for now, or check if IAuthorizedPublicKey is available
    {
        /// <summary>
